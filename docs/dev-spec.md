...
유튜브 채널 **유관** 8편(1평 홈짐 루틴 설계) 시청자용 웹앱.
...
export const EXERCISES: Exercise[] = [
  ...
  { id: 'lying-db-lateral-raise', name: '라잉 사이드 래터럴 레이즈', pattern: 'lateral_raise', category: '어깨',
...
| 덤벨 싱글렉 (B-Stance) RDL | 덤벨 스플릿 스탠드 RDL | B-스탠스는 싱글레그가 아님 (뒷발 접지) |
| 사이드 래터럴 레이즈 | 사이드 래터럴 레이즈 | lateral=측면. 동어반복 제거 |
| 덤벨 프레스 | 덤벨 벤치프레스 | 벤치 사용 동작 |
| 딥스 (Dips) | 딥스 | 가슴 계수 1.0 → 가슴 지향 변형 명시 |
